...
#include "interfaces/srv/detail/chat__rosidl_typesupport_fastrtps_c.h"
...
using _Chat_Request__ros_msg_type = interfaces__srv__Chat_Request;
...
size_t get_serialized_size_interfaces__srv__Chat_Request(
  const void * untyped_ros_message,
...
static uint32_t _Chat_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__srv__Chat_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__srv__Chat_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__srv__Chat_Request;
    is_plain =
      (
...
static size_t _Chat_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__srv__Chat_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, Chat_Request)() {
...
using _Chat_Response__ros_msg_type = interfaces__srv__Chat_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_interfaces__srv__Chat_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Chat_Response__ros_msg_type * ros_message = static_cast<const _Chat_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__srv__Chat_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__srv__Chat_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__srv__Chat_Response;
    is_plain =
      (
...
static size_t _Chat_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__srv__Chat_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, Chat_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, Chat)() {
  return &Chat__handle;
}
