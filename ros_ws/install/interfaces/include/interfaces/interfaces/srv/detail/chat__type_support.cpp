...
{
  new (message_memory) interfaces::srv::Chat_Request(_init);
}

void Chat_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::srv::Chat_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Chat_Request_message_member_array[1] = {
  {
    ...
    offsetof(interfaces::srv::Chat_Request, message),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Chat_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(interfaces::srv::Chat_Request),
...
{
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::Chat_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, Chat_Request)() {
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::Chat_Request_message_type_support_handle;
}
...
void Chat_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) interfaces::srv::Chat_Response(_init);
}

void Chat_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::srv::Chat_Response *>(message_memory);
  typed_message->~Chat_Response();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Chat_Response_message_member_array[1] = {
  {
    "response",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_STRING,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::srv::Chat_Response, response),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Chat_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(interfaces::srv::Chat_Response),
...
{
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::Chat_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, Chat_Response)() {
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::Chat_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Chat_service_members = {
  ...
  // see get_service_type_support_handle<interfaces::srv::Chat>()
...
get_service_type_support_handle<interfaces::srv::Chat>()
{
  ...
  auto service_type_support =
    &::interfaces::srv::rosidl_typesupport_introspection_cpp::Chat_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, Chat)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<interfaces::srv::Chat>();
}
